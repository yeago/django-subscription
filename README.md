...
# Emitting
    ...
    Subscription.objects.emit_model("comment.create", comment_obj,
                             subscribers_of=comment_obj.content_object)
    #  Reads settings.SUBSCRIPTION_MODELSPEC_MAP for a callable accepting
    #  a verb and model instance and returning an activitystream spec
